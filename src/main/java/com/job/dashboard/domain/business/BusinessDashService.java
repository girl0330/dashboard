...
public interface BusinessDashService {
    ...
    //프로필
    Map<String, Object> insertProfile(CompanyInfoDTO companyInfoDTO); //기업 프로필 작성/수정
    ...
    //채용
    Map<String, Object> employCandidate(JobApplicationDTO jobApplicationDTO);
    Map<String, Object> cancelEmployCandidate(JobApplicationDTO jobApplicationDTO);     //채용 취소
